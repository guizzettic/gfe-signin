...
const Subscription: React.FC<SubscriptionProps> = ({ plan }) => {
  ...
  return (
    <div className="flex flex-col justify-between gap-2 self-stretch rounded-lg border-[0.5px] border-solid border-neutral-200 bg-gray-400 md:min-h-[532px]">
      {popular && (
      ...
      <div className="flex flex-col gap-2 bg-yellow-200 p-4 md:px-8">
      ...
      <div className="flex flex-col gap-2 p-4 md:px-8">
        <div>
      ...
      <ul className="flex flex-col gap-5 self-stretch p-4 md:min-h-44 md:px-8">
      ...
      <div className="flex flex-col justify-center gap-2 self-stretch px-4 pb-4 md:px-8 md:pb-6">
        <button
